...
Erizo.Connection = function (spec) {
    ...
    } else if (BrowserDetect.browser == "Chrome" && (BrowserDetect.version == "25"|| BrowserDetect.version== "26")) {
        // Google Chrome Stable.
        console.log("Stable!");
        that = Erizo.ChromeStableStack(spec);
        that.browser = "chrome-stable";
    } else if (BrowserDetect.browser == "Chrome" && (BrowserDetect.version == "27"|| BrowserDetect.version== "28")) {
